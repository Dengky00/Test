<template>
  <div class="content">
    <table class="table-goods" v-if="cart.length">
      ...
      <tr
        ...
        <td class="col05">
          ...
          <span class="btn-text" @click="pay(item, index)"><router-link to='/pay'>结算</router-link></span>
        </td>
      </tr>
      </tbody>
    </table>
    ...
    <div class="banner-pay">
      ...
      <router-link to='/pay'><span class="btn-pay" @click="payAll">结&nbsp;&nbsp;算</span></router-link>
    </div>
  </div>
</template>
